    ...
    return (
        <section className="grid grid-cols-3 text-xs bg-black pt-1 pb-2 px-1 border-[1px] m-0 border-zinc-800 rounded-t-2xl">
            <div className="col-span-1 flex justify-center items-center">
                <div id='nowPlaying' className={pathname === "/radio" ? "hidden" : "content-center border-[1px] border-zinc-800 bg-white/5 rounded-xl mr-4 md:mr-0 text-zinc-300 max-w-[89px] w-fit text-center md:max-w-64 md:px-4 pb-2"}>
                    <Link href="/radio">
